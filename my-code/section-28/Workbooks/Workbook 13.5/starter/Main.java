...
public class Main {
    public static void main(String[] args) {
        ...
        books.stream()
                ...
                .sorted((book1, book2) -> Integer.compare(book1.getYear(), book2.getYear())) // sorting by year
                .map(book -> new Book(book.getTitle(), book.getGenre(), book.getYear(), book.getPrice() / 2)) // halve
                                                                                                              // the
                                                                                                              // price
