...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out
                .print("\nYou have " + contactManager.getContactCount() + " contacts. Enter 'continue' to edit them: ");
        String status = scan.nextLine();

        while (status.equals("continue")) {
            System.out.print("\nChoose an index from 0 to " + (contactManager.getContactCount() - 1) + ": ");
            int index = scan.nextInt();
            scan.nextLine(); // throwaway nextLine

            if (index >= 0 && index < contactManager.getContactCount()) {
                System.out.println("\nEditing contact at index " + index + ":");
            ...
            System.out.print("\nDo you want to edit another contact? Enter 'continue' to edit: ");
    ...
    private static Contact editedContact() {
    ...
    private static void displayContacts(ContactManager contactManager) {
